...
public class ContratoBaseDatos {
    ...
    public static final Uri CONTENT_URI_MAPA = Uri.withAppendedPath(CONTENT_URI, TablaMapa.TABLA);
    ...
    public static abstract class TablaLista implements BaseColumns {
        ...
        public static final String SORT_ORDER_DEFAULT = _ID + " desc"; /*Tipos MIME*/
    ...
    public static abstract class TablaMapa implements BaseColumns {
        /*BaseColumns incluye de forma predeterminada el campo _id*/
        public static final String TABLA = "mapa";
        public static final String ID_NOTA = "id_nota";
