...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
        ...
        RuntimeExceptionDao<MapaORM, Integer> dao = getSimpleDataDao();
        long millis = System.currentTimeMillis();
        // create some entries in the onCreate
        MapaORM simple = new MapaORM(0, null, null, null);
        dao.create(simple);
        simple = new MapaORM(0, null, null, null);
        dao.create(simple);
     ...
     */
    public RuntimeExceptionDao<MapaORM, Integer> getSimpleDataDao() {
